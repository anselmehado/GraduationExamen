...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { name_produit: @produit.name_produit, prix_produit: @produit.prix_produit, ref_produit: @produit.ref_produit } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { name_produit: @produit.name_produit, prix_produit: @produit.prix_produit, ref_produit: @produit.ref_produit } }
